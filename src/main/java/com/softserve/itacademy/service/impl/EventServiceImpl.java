...
//    @Override
//    public List<Event> getAllByUserId(long id) {
//        List<Event> events = repository.getAllByUserId(id);
//        return events.isEmpty() ? new ArrayList<>() : events;
//    }
//
//    @Override
//    public List<Event> getAttendeesEvents(long id) {
//        List<Event> events = repository.getAttendeesEvents(id);
//        return events.isEmpty() ? new ArrayList<>() : events;
//    }
