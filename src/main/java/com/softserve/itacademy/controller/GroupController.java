...
public class GroupController {
    //    private final Logger logger = new AppLogger("GroupController.class");
    ...
    public String create(@RequestParam("educationForm_id")long educationFormId,
        ...
        if(educationFormId<0){
            result.rejectValue("educationFormId", "Education form needs to be selected");
    ...
    public String read(@PathVariable long id, Model model, @PathVariable Optional<Integer> plusWeek) {
        ...
        Locale locale = com.softserve.itacademy.tools.Settings.locale;
